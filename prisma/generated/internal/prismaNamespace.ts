...
> = {
	...
	meta: {
		modelProps: 'user' | 'customer' | 'invoices';
		...
		invoices: {
			...
			operations: {
				...
				count: {
					...
					result:
						| runtime.Types.Utils.Optional<Prisma.InvoicesCountAggregateOutputType>
						| number;
				};
			};
		};
...
/**
 * Reference to a field of type 'InvoicesStatus'
 */
export type EnumInvoicesStatusFieldRefInput<$PrismaModel> = FieldRefInputType<
	$PrismaModel,
	'InvoicesStatus'
>;
 ...
 * Reference to a field of type 'InvoicesStatus[]'
 */
export type ListEnumInvoicesStatusFieldRefInput<$PrismaModel> =
	FieldRefInputType<$PrismaModel, 'InvoicesStatus[]'>;
